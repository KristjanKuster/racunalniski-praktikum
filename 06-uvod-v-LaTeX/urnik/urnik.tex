...
% Spodaj je primer vsebine XML datoteke, ki ga označite z okoljem `ve{rbatim`.
...
tip (npr. \textbf{strong}bool v C++), kjer bi vrednost \textbf{strong}true predstavljala
dosegljivost, \textbf{strong}false pa zasedenost.
